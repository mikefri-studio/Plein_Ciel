...
+versionBlock('1.7.6','28 août 2026',[
  ...
  "⚙️ Nouveau menu Paramètres",
  "📏 Rayon d'alerte pluie réglable : 2 / 5 / 10 / 20 km",
  ...
  "🕐 Détail horaire : clic sur un jour → 24h de prévisions",
  ...
  "🔔 Alerte orage activable : bannière + son + vibration"
])+versionBlock('1.5.0','11 août 2026',[
  "🖼️ Carte de partage : image météo + QR code"
  ...
  "⚙️ Réglages d'alerte déplacés dans les paramètres",
  "🏗️ Code découpé en ~20 modules",
  "📖 README + historique des versions"
])+versionBlock('1.3.0','10 août 2026',[
  "📍 Nom de ville automatique à la géolocalisation",
